...
{
    public class MultiController : NPartyController
    {
        //
        // GET: /Multi/Multi/
        ...
        protected ActionResult OpenPageByLabel(string label, int? page)
        {
            ...
            List<Article> articles = Helper.GetArticlesFromBlog(MainBlogId, "Multi", MaxPosts, (MaxPosts * pageValue) + 1, label, "/Artigos/Ler/");
        ...
        private static string apiKey = System.Configuration.ConfigurationManager.AppSettings["MultiBloggerApiKey"];
        private static string appName = System.Configuration.ConfigurationManager.AppSettings["MultiGoogleAppName"];
